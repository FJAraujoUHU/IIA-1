...
public class SQLSolicitorPort implements Runnable {
    ...
    public SQLSolicitorPort(Slot in, Slot out, String hostname, int port, String user, String password, String schema, boolean autocommit) throws ClassNotFoundException, SQLException {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(SQLSolicitorPort.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
